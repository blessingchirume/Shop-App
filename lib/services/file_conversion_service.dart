...
class FileConversionService {
  static String convertFileToString() {
    final bytes = File('assets/main/avatar.png').readAsBytesSync();
  ...
  Future<File> get _localFile async {
    ...
    return new File('$path/print_out.pdf').create(recursive: true);
  }
  ...
  Future<Uint8List> readCounter() async {
    try {
      final file = await _localFile;
      writeCounter('test message');
      final contents = await file.readAsBytesSync();
      return contents;
    } catch (e) {
  ...
  Future<Uint8List> getImageFileFromAssets(String path) async {
    ...
    var test = await getGraphicsTicket();

    var uint8List = Uint8List.fromList(test);
